...
inputs = {
  ...
  */
  image = "306315756373.dkr.ecr.us-east-2.amazonaws.com/jenkins:a9827f7"
  certificate_arn = "arn:aws:acm:us-east-2:306315756373:certificate/b82a67b7-74d2-42cb-bc5b-202e68452166"
